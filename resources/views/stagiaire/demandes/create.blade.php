...
@section('content')
    ...
    <div class="mon-profile d-flex">
        ...
        <h3 class="mt-2 container profile">Crée votre demande</h3>
    </div>
    ...
    <div class="container">
        <div class="row m-5">
            ...
            <div class="col-md-8">
                ...
                <div id="parametres">
                    <span class="add">Formulaire d'ajouter une demande</span>
                </div>
                ...
                <form method="POST" action="{{ route("demandes.store") }}">
                    ...
                    <div class="mt-4 form-group row">
                        <div class="col-xs-12 col-md-9 mx-auto">
                            ...
                            <input type="text" name="title" value="{{ old("title") }}" class="form-control @error("title") is-invalid @enderror" id="title" placeholder="Ex: Titre de poste..." required>
                        </div>
                    ...
                    <div class="mt-4 form-group row">
                        <div class="col-xs-12 col-md-9 mx-auto">
                            ...
                            <select name="duree" class="form-control @error("duree") is-invalid @enderror" required>
                                <?php for($i=1; $i<=6; $i++): ?>
                                    <option value="{{ $i }}" {{ (old("duree") == $i) ? 'selected' : '' }}>{{ $i }} mois</option>
                                <?php endfor ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-9 mx-auto">
                       <button type="submit" class="btn btn-primary btn-block text-uppercase">Ajouter votre demande</button>
                    </div>
                </form>
            </div>
        </div>
