...
<div class="maincontainer">
  ...
  <div class="errortext">Vous n'aves l'autorisation pour accéder à cette page!</div>
  <h5 class="text-center accueil">
        Retour à la page
        <a href="/" class="text-decoration-none"><b>d'accueil</b></a>
    </h5>
